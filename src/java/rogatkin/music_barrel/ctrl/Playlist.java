...
@DataRelation(query = "select i.title, i.performer, track, year, l.title album, genre, path from mb_media_item i join mb_play_list_map m on m.item_id=i.id join mb_play_list l on l.id = m.list_id where l.title=':list_name'", keys = { "list_name" })
